...
short int hashMapInit(hashMap_t* map, unsigned long int(* hmHashFN)(void* key), int(* hmEqFN)(void* p1, void* p2), unsigned long int start_len, float load_factor)
{
...
unsigned long int hmPtrHash(void* key)
{
	return (unsigned long int) key;
}

/* simple string hash function */
unsigned long int hmStringHash(void* key)
{
